...
const ExperienceSection = ({ handleRedirect }) => {
  ...
  return (
    <section
      id="experience"
      className="w-full bg-black text-white sm:px-20 px-5 py-20 border-b border-[#2c3437] overflow-hidden"
    >
      <div className="mb-16">
        <h2 className="text-4xl font-bold mb-3 relative left-title">
          Experience
        </h2>
        ...
        <Card className="bg-zinc-900/50 border border-green-500/20 hover:border-green-500/50 transition-colors duration-300 backdrop-blur-sm">
          <CardContent className="pt-6">
            ...
            <p className="text-gray-300">
              ...
              <span className="text-green-500"> smooth</span> applications.
            </p>
          </CardContent>
        </Card>
      </div>
