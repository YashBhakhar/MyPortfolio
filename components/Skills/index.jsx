...
const SkillsSection = () => {
  ...
  const skills = [
    ...
    { name: "ExpressJS", category: "Backend", icon: "/express.png", color: "#7952b3" },
    { name: "MongoDB", category: "Backend", icon: "/mongodb.svg", color: "#7952b3" },
    { name: "Netlify", category: "DevOps", icon: "/netlify.svg", color: "#7952b3" },
