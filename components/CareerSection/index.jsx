...
const CareerSection = () => {
  return (
    <section
      id="career"
      className="py-20 bg-black px-4 border-b border-[#2c3437] overflow-hidden"
    >
      <div className="container mx-auto text-center">
        <h1 className="text-4xl font-bold text-white mb-4 relative center-title">
          Career
        </h1>
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            <Card className="bg-zinc-900/50 border-green-500/20 hover:border-green-500/40 transition-colors">
              <CardContent className="p-6 space-y-4">
                ...
                <p className="text-gray-400 text-left">
                  Specialized work in web designing and React development,
            ...
            <Card className="bg-zinc-900/50 border-green-500/20 hover:border-green-500/40 transition-colors">
              <CardContent className="p-6 space-y-4">
                ...
                <p className="text-gray-400 text-left">
                  Gained practical experience in software development through
                  internship at Tops Technologies
                </p>
              </CardContent>
            </Card>
            {/* BCA Education */}
            <Card className="bg-zinc-900/50 border-green-500/20 hover:border-green-500/40 transition-colors">
              <CardContent className="p-6 space-y-4">
                ...
                <p className="text-gray-400 text-left">
                  Completed Bachelor of Computer Applications from Swarrnim
